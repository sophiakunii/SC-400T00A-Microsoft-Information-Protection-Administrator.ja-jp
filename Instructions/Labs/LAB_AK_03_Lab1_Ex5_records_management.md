...
8. 「**保持設定の定義**」ページで、次のオプションを選択して、「**次へ**」を選択します。
    - **アイテムを無期限または特定の期間保持する**
    - **保持期間**: 7 年
    - **保持期間開始の条件**: アイテムの作成日時
    - **保持期間中**: アイテムをレコードとして分類する
    - **保持期間後の動作を選択する**: 処理確認を開始する

9. 「**+ ステージの作成とレビュー担当者の割り当て**」をクリックして、「**+ ステージの追加**」をクリックします。
...
7. 「**Employee Data**」ラベル、「**追加**」、「**次へ**」の順に選択します。 
...
11. 「**ポリシーの名前を設定**」ページで、次の情報を入力して、「**次へ**」を選択します。
    - **名前**: Employee Health Insurance label policy
...
6. 「**Employee Data**」ラベルを選択して、レコード ラベルを適用します。  

7. マウスの右ボタンを使って、「**Employee Data**」とラベル付けしたメール アイテムを選択し、「**削除**」を選択します。
