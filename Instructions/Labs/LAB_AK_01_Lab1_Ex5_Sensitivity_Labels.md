...
1. Microsoft Purview ポータルの左ナビゲーション ペインで、 **[情報の保護]** を選択します。  

1. [情報の保護] ページの **[ラベル]** タブで、**[+ ラベルの作成]** を選択します。
...
1. **[このラベルのスコープを定義する]** ページで、メール、ファイル、Power BI アイテムを保護する **[アイテム]** オプションを選択します。
...
1. **[Auto-labeling for schematized data assests(preview)]\(スキーマ化されたデータ アセット (プレビュー) の自動ラベル付け\)** ページで、 **[次へ]** を選択します。 
...
1. ドロップダウン メニューで **[+ サブ ラベルの追加]** を選択します。
...
1. **[ラベル付きのアイテムの保護設定を選択する]** ページで、 **[ファイルとメールを暗号化する]** オプションを選択します。
...
1. **[情報の保護]** ページの **[ラベル]** タブで、**[ラベルを発行]** を選択します。
...
1. **[ドキュメントに既定のラベルを適用する]** ページで **[次へ]** を選択します。

1. **[電子メールに既定のラベルを適用する]** ページで **[次へ]** を選択します。

1. **[Power BI コンテンツにこの既定のラベルを適用する (プレビュー)]** ページで、 **[次へ]** を選択します。
...
1. **[Office 365 で作業を行ってください]** というメッセージが表示された場合は、右上隅の **[X]** をクリックして閉じます。
...
1. 上部ペインの上部にある **[秘密度]** を選択し、ドロップダウン メニューを開きます。 **[内部]** を選択してラベルを適用します。
...
1. Outlook on the web で、ウィンドウの左上にある **[新しいメッセージ]** を選択します。
...
1. 下部のメニューからクリップのシンボルを選択し、**[添付ファイルの候補]** の下から **HR Document.docx** を選択してドキュメントを添付します。
...
1. Microsoft Purview ポータルの左ナビゲーション ペインで、 **[情報の保護]** を選択してから、 **[ラベル]** を選択します。 

1. [情報の保護] ページで、既存の **[内部]** ラベルを (選択せずに) 強調表示し、省略記号 (3 つの点) を選択します。

1. **[+ サブ ラベルの追加]** メニュー項目を選択します。
