...
3. **Microsoft 365 コンプライアンス** ポータルの左ナビゲーション ウィンドウで、「**情報の保護**」を選択します。  
...
16. 「情報保護」ページで、新しく作成した「**Internal**」ラベルを (選択せずに) 垂直の **[...]** を選択します。
...
22. 「**ファイルと電子メールの保護設定の選択**」ページで、「**ファイルと電子メールの暗号化**」オプションを選択します。
...
27. 「アクセス許可の割り当て」メニューで、「**+ 任意の認証済みユーザーを追加**」を選択します。
...
32. 「**スキーマ化されたデータ アセットの自動ラベル付け (プレビュー)**」ページで、「**次へ**」をクリックします。 
...
8. 「**Internal**」と「**Internal/Employee data (HR)**」チェックボックスを選択します。
...
15. 「**Power BI コンテンツに既定のラベルを適用する (プレビュー)**」ページで「**次へ**」を選択します。
...
4. 「情報保護」ページで、既存の「**Internal**」ラベルを (選択せずに) 強調表示し、省略記号 (3 つの点) を選択します。
...
13. 「**コンテンツに含まれている場合**」セクションで、「**テ追加**」を選択し、「**機密情報の種類**」を選択します。
...
27. 「**発行する秘密度ラベルを選択**」ページで、「**発行する秘密度ラベルを選択**」を選択します。

28. 右側には、「**発行する秘密度ラベル**」というサイド バーが表示されます。

29. 「**Internal**」と「**Internal/GDPR Germany**」チェックボックスを選択します。
...
36. 「**Power BI コンテンツに既定のラベルを適用する (プレビュー)**」ページで「**次へ**」を選択します。 
