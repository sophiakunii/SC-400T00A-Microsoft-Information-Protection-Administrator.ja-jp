...
1. **[スキーマ化されたデータ アセットの自動ラベル付け (プレビュー)] ** ページで、**[次へ]** を選択します。

1. **[設定を確認して完了]** ページで、**[ラベルの作成]** を選択します。

1. ラベルが作成されると、"**秘密度ラベルが作成されました**" というページが表示されます。

1. **[ポリシーをまだ作成しない]** を選択してから、 **[完了]** を選択します。
...
1. **[このラベルのスコープを定義]** ページで、**[アイテム]** オプションを選択し、**[ファイル]** と **[メール]** を選択します。

1. [**次へ**] を選択します。

1. **[選択した項目の種類の保護設定を選択します]** ページで、 **[アクセスの制御] ** オプションを選択します。
...
1. **[内部]** と **[internal/従業員データ (HR)]** チェックボックスをオンにします。
...
1. **[ポリシーの設定]** ページで **[次へ]** を選択します。

1. **[Default settings for documents] (ドキュメントの既定の設定)** で、 **[次へ]** を選択します。

1. **[Default settings for emails] (メールの既定の設定)** で、 **[次へ]** を選択します。

1. **[会議と予定表イベントの既定の設定]** で、 **[次へ]** を選択します。

1. **[Fabric および Power BI コンテンツの既定の設定] ** で、 **[次へ]** を選択します。
