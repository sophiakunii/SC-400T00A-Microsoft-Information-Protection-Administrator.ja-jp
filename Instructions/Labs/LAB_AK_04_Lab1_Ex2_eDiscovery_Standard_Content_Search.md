...
このタスクでは、Joni Sherman として電子情報開示 (Standard) ケースを作成します。
...
1. **[電子情報開示 (Standard)]** で、 **[+ ケースの作成]** を選択します。
...
1. **[電子情報開示 (Standard)]** ページに戻り、 **[設定]** を選択します。

1. **[アクセスとアクセス許可]** で、 **[選択]** を選択します。

1. **[アクセスとアクセス許可]** ポップアップ ページの **[メンバーの管理]** で、 **[+ 追加]** を選択します。

1. **[メンバーの追加]** ポップアップ ページで、「*Diego*」と入力し、Enter キーを押して、*Diego Siciliani* を見つけます。

1. Diego の名前の横にあるチェックボックスをオンにし、ページの下部にある **[追加]** を選択します。

1. **[アクセスとアクセス許可]** ページに戻り、 **[終了]** を選択して、ケース設定ページに戻ります。
...
1. 右側の **[新しいホールド]** ポップアップ ページの **[名前]** フィールドの下にある **[Name your hold](ホールドの名前の設定)** に、「Wrongful Termination Hold」と入力します。** **[説明]** フィールドに、「*この訴訟ホールドは、Contoso Ltd. の不当解雇訴訟に関係するものであり、このケースに関連するすべての関連電子データを保持するように設計されています。* 」と入力します。

1. **[次へ]** を選択します。

1. **[場所の選択]** ページで、 **[Exchange メールボックス]** を選択します。 **[含める]** で、 **[ユーザー、グループ、チームを選択]** を選択します。

1. 右側の **[Exchange メールボックス]** ポップアップ ページで、 **[検索]** フィールドに「*Lidia*」と入力し、Enter キーを押します。 **[Lidia Holloway]** のチェックボックスをオンにし、 **[完了]** を選択します。
...
電子情報開示 (Standard) ホールドが正常に作成されました。
...
1. **[新しい検索]** ウィザードの **[名前と説明]** で、 **[名前]** フィールドに「Wrongful Termination Search」と入力します。** **[説明]** フィールドに、「*この検索は、Contoso Ltd. の不当解雇訴訟に関係するものであり、このケースに関連するすべての関連電子データを特定して収集するように設計されています。* 」と入力します。
...
1. KQL エディター ボックスに「`To:Lidia OR From:Lidia OR Cc:Lidia OR Bcc:Lidia`」と入力し、 **[次へ]** を選択します。
...
1. 左側のナビゲーション ペインから **[コンテンツ検索]** に移動します。 **[コンテンツ検索]** ページで、Wrongful Termination Search の状態が **[開始中]** の場合は、状態が **[完了]** と表示されるまで検索を更新します。

1. **[Wrongful Termination Search]** を選択して **[Wrongful Termination Search]** ポップアップ ページを表示し、 **[検索の統計情報]** を選択します。 **[コンテンツの検索]** を展開し、 **[条件レポート]** 、 **[上位の場所]** の順に選択し、コンテンツ検索に関する統計情報を表示します。

1. ページの下部にある **[アクション]** ボタンを選択し、 **[結果のエクスポート]** を選択します。
...
1. **[コンテンツ検索]** ページに戻り、上部のナビゲーション バーから **[エクスポート]** タブを選択します。 **[Wrongful Termination Search_Export]** という名前のジョブを選択します
...
1. **[Wrongful Termination Search_Export]** ページの上部で、 **[レポートのダウンロード]** を選択して、レポートをダウンロードします。
...
1. **[処理が完了しました]** に緑色のチェック マークが表示されたら、 レポートがダウンロードされました。 **[閉じる]** を選択して、ウィンドウを閉じます。
...
1. 左側のナビゲーション ペインから **[コンテンツ検索]** に移動します。

1. **[コンテンツ検索]** ページから **[Wrongful Termination Search]** を選択すると、右側に **[Wrongful Termination Search]** ポップアップ ページが表示されます。

1. **[Wrongful Termination Search]** ポップアップ ページで、 **[検索の統計情報]** を選択し、 **[コンテンツの検索]** 、 **[条件レポート]** 、 **[上位の場所]** を展開して、コンテンツ検索に関する統計情報を表示します。

1. ペインの下部にある **[アクション]** ボタンを選択し、 **[レポートのエクスポート]** を選択します。
...
1. **[コンテンツ検索]** ページに戻り、上部のナビゲーション バーから **[エクスポート]** タブを選択します。 **Wrongful Termination Search_ReportsOnly** という名前のレポートが作成されます。
