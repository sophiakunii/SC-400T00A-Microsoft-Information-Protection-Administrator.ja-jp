...
1. **[ポリシーを適用する場所を選択する]** 領域で、 **[Exchange メールボックス]** 、 **[SharePoint クラシック サイトとコミュニケーション サイト]** 、 **[OneDrive アカウント]** 、 **[Microsoft 365 グループのメールボックスとサイト]** が選択されていることを確認して、 **[次へ]** を選択します。
...
1. **[クエリ演算子]** 、 **[属性]** 、 **[演算子]** 、 **[値]** に、次の情報を入力します。
    ...
    - **演算子**: が次の値に等しい
    - **値**: 小売
1. 各値の横にあるチェック ボックスがオンになっていることを確認します。
1. **[次へ]** ボタンを選択します。
1. **[確認と完了]** ページで、**[送信]** ボタンを選択します。
...
1. **[ポリシーを適用する場所の選択]** で、次の情報を入力します。
    ...
    - **Exchange メールボックス** – **状態**: オン
    - **OneDrive アカウント** – **状態**: オン
    - その他の場所はすべて自動的に**オフ**になります。
