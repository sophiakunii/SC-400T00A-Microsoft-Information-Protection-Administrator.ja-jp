...
4. 「**データ ライフサイクル管理**」ページの「**アイテム保持ポリシー**」タブで、「**+ 新しいアイテム保持ポリシー**」を選択します。
...
9. 「**コンテンツを保持するか、削除するか、またはその両方を行うかを決定する**」ページで、「**特定の期間のアイテムを保持する**」セクションで、次の情報を入力します。
	...
	- 特定の期間アイテムを保持する: ドロップダウン リストから「**カスタム**」を選択します。
	- 年フィールドを「**3**」に変更します。
...
4. 「**データ ライフサイクル管理**」ページの「**アイテム保持ポリシー**」タブで、「**+ 保持ポリシーの新規作成**」を選択します。
...
9. **Teams のチャット**の場所として、「**すべてのユーザー**」の下で、「**編集**」を選択します。
