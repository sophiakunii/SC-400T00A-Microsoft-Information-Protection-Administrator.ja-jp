...
14. 「**保持ラベルの名前を設定**」ページで、「**名前**」、「**ユーザー向けの説明**」、「**管理者向けの説明**」に次の情報を入力します。
	- **名前**: クレジット カードの領収書
...
11. オプションが利用可能な場合は、「**ラベルの適用**」を「**VAT の還付と関連文書**」に設定し、「**保存**」を選択します。保持ラベルの発行には時間がかかる場合があるため、すぐにオプションが利用できない場合もあります。利用できない場合は、次のタスクに進みましょう。後でこのタスクに戻り、再試行してください。
...
8. オプションが利用可能な場合は、「**保持ラベルを適用する**」を「**VAT の還付と関連書類**」に設定します。保持ラベルの発行には時間がかかる場合があるため、すぐにオプションが利用できない場合もあります。利用できない場合は、次のタスクに進みましょう。後でこのタスクに戻り、再試行してください。
