...
39. 上部メニューのその他のオプション (...) をクリックして、「**+ EDM 機密情報の種類を作成**」を選択して、「**EDM 規則パッケージ**」ウィザードを開きます。  
...
44. 右側にある「**新しいパターン**」ウィンドウの主要要素フィールドで「*EmployeeID*」を選択します。
...
51. 「**名前と EDM 機密情報の種類の説明**」ページで、名前に対して、「*Contoso Employee EDM*」と入力します。
