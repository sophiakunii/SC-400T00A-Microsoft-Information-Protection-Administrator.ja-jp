...
5. 「**機密情報の種類**」タブで、「**+ 情報の種類を作成**」を選択し、新しい機密情報の種類を作成するウィザードを開きます。

6. 「**機密情報の種類に名前を付ける**」ページで、「**名前**」に「*Contoso Employee ID*」を入力します。

7. 「**説明**」フィールドに**Contoso Employee ID のパターン**と入力して「**次へ**」を選択します。
...
12. 「ID」フィールドに **Employee ID キーワード** と入力し、**大文字と小文字を区別しない**下のテキスト ボックスに、ボックス内の別々の行に次のように入力して、「**完了**」を選択します。
...
23. 「**データ分類**」を選択し、「**完全データ一致**」タブを上部のウィンドウから選択します。
...
29. 最初の「**スキーマ フィールド名**」で 「*Name*」 と入力し、「**フィールドは検索可能**」にマークを付けます。
...
39. 上部メニューのその他のオプション (...) をクリックして、「**+ EDM 機密情報の種類を作成**」を選択して、「**EDM ルールパッケージ**」ウィザードを開きます。  
...
44. 右側にある「**新しいパターン**」ウィンドウの一次要素フィールドで「*EmployeeID*」を選択します。

45. 「**主要要素の機密情報の種類**」で、「**機密情報の種類を選択する**」を選択します。 

46. 「**検索**」バーで、 「*Contoso*」 と入力し、Enter キーを押します。

47. 「**Contoso Employee ID**」を選択し、「**完了**」を選択します。

48. 「**完了**」を選択します。

49. 「*この EDM 機密情報の種類のパターンを定義する*」 で、「**次へ**」を選択します。

50. 「**信頼度の推奨レベルと文字の近接度を選択する**」で、既定値を維持し、「**次へ**」を選択します。

51. 「**EDM の機密情報の種類の名前と説明の設定**」ページで、名前に対して、「*Contoso Employee EDM*」と入力します。
...
2. **Microsoft Edge** で、**https://go.microsoft.com/fwlink/?linkid=2088639** に移動し、EDM Upload Agent をダウンロードします。

3. 「**実行**」を選択して、ツールをインストールします。
...
5. 「**機密情報の種類に名前を付ける**」ページで、「**名前**」フィールドに「*Contoso Diseases List*」を入力します。
...
14. 「**キーワード リストの追加**」ページで、「**ID**」フィールドに「*Employee absence*」と入力します。「**大文字と小文字を区別しない**」ボックスに、次のキーワードをそれぞれ別々の行に入力します。
...
11. 「**Contoso Employee ID**」を選択して、右側のウィンドウを開きます。
