...
1. 左側のナビゲーションから **[コミュニケーション コンプライアンス]** をクリックします

1. **[ポリシー]** をクリックします

1. **[+ ポリシーの作成]** をクリックし、ドロップダウンから **[カスタム ポリシー]** を選択します

1. **[ポリシーの名前と説明の設定]** ページで、 **[名前]** フィールドに「**財務上の秘密の検出**」と入力します

1. **[説明]** フィールドに「**財務上の秘密の共有の検出**」と入力します

1. **[次へ]** を選択します

1. **[ユーザーとレビューの選択]** ページの **[ユーザーとグループの選択]** で **[すべてのユーザー]** を選択したままにしておきます。

1. **[レビュー担当者]** フィールドで、 **[Joni Sherman]** と **[MOD 管理者]** を選択します

1. **[次へ]** を選択します

1. **[コミュニケーションを検出する場所の選択]** ページで、 **[Exchange]** を選択します

1. **[次へ]** を選択します

1. **[条件とレビューの割合を選ぶ]** ページの **[コミュニケーション ダイレクト]** で、既定値を選択したままにしておきます。

1. **[条件]** で、 **[+ 条件の追加]** を選択します

1. **[次のいずれかの単語が含まれるメッセージ]** を選択します

1. **[次のいずれかの単語が含まれるメッセージ]** の下にあるフィールドに、「秘密」と入力します**
